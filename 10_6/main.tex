...
Given that,
\begin{align}
	\pr{E_2} &= 2 \times \pr{E_1}\\
	\pr{E_3} &= 4 \times \pr{E_1}\\
	\pr{E_4} &= \pr{E_1}
\end{align}
Also,\\
$$ \pr{E_1} + \pr{E_2} + \pr{E_3} + \pr{E_4} = 1 $$\\
Hence, we get \begin{enumerate}
	\item
	\begin{enumerate}
		\item $\pr{E_1} = \frac{1}{8}$ \\
		\item $\pr{E_2} = \frac{1}{4}$ \\
		\item $\pr{E_3} = \frac{1}{2}$ \\
		\item $\pr{E_4} = \frac{1}{8}$ \\
	\end{enumerate}
	\item $\pr{E_1 + E_4} = \frac{1}{4}$ 
\end{enumerate}
\end{document}
