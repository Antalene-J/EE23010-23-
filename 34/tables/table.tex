...
\ifthenelse{\isundefined{\gnumericColC}}{\newlength{\gnumericColC}}{}\settowidth{\gnumericColC}{\begin{tabular}{@{}p{108pt*\gnumericScale}@{}}x\end{tabular}}
...
\hhline{|---|}
	...
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 ...
	 \multirow{5}[2]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
...
\hhline{~|--|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{Rs. 1000 }}
\\
\hhline{~|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{}
